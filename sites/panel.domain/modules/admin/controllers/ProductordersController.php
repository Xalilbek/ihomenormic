...
class ProductordersController extends \Phalcon\Mvc\Controller
{
		...
		if ($data)
		{
			foreach($data as $value)
			{
				$records["data"][] = array(
                    ...
                    round($value->total, 2)." DKK",
					'',
					//'<a href="'._PANEL_ROOT_.'/prod/edit/'.$value->id.'" class=""><i class="la la-edit"></i></a>'
