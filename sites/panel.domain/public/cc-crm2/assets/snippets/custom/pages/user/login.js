                    ...
                    t.addClass("m-loader m-loader--right m-loader--light"),
                        r.ajaxSubmit({
                            ...
                            success: function(e, i, a, l) {
                                t.removeClass("m-loader m-loader--right m-loader--light");
                                if(e.status == 'success'){
                                    window.location = '';
                                }else if(e.status == 'error'){
                                    $("#error_alert").html(e.description).css("display","block");
                                }
                            }
                        })
                )
                ...
                r.validate({
                    ...
                    success: function(e, i, a, l) {
                        setTimeout(function() {
                            t.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), r.clearForm(), r.validate().resetForm(), o();
                            var e = s.find(".m-login__signin form");
                            e.clearForm(), e.validate().resetForm(), n(e, "success", "Gendannelsesinstruktioner er nu sendt til e-mail adressen.")
                        }, 2e3)
                    }
                }))
            })
