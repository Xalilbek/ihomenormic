    ...
    return function(n) {
        ...
        o.compensateScroll = function(t, e) {
            ...
            var o = Math.floor(t / i.length),
                ...
                u = [],
                d = 0;
            n(i), i.each(function(t, e) {
                var n = t === i.length - 1 ? s : o,
                    r = c(e).outerHeight(!0);
                r < n ? (a.push(e), l.push(r), u.push(c(e).height())) : d += r
        ...
        o.isPrimaryMouseButton = function(t) {
            ...
            var e, n, r = [],
                i = [];
            for ("string" == typeof t ? i = t.split(/\s*,\s*/) : "function" == typeof t ? i = [t] : c.isArray(t) && (i = t), e = 0; e < i.length; e++) "string" == typeof(n = i[e]) ? r.push("-" === n.charAt(0) ? {
                field: n.substring(1),
                order: -1
            } : {
                field: n,
            ...
            var r;
            return g(n) ? (e - t) / n : (r = n.asMonths(), 1 <= Math.abs(r) && w(r) ? e.diff(t, "months", !0) / r : e.diff(t, "days", !0) / n.asDays())
        }, o.divideDurationByDuration = function(t, e) {
            var n, r;
            return g(t) || g(e) ? t / e : (n = t.asMonths(), r = e.asMonths(), 1 <= Math.abs(n) && w(n) && 1 <= Math.abs(r) && w(r) ? n / r : t.asDays() / e.asDays())
        }, o.multiplyDuration = function(t, e) {
            var n;
            return g(t) ? r.duration(t * e) : (n = t.asMonths(), 1 <= Math.abs(n) && w(n) ? r.duration({
                months: n * e
            }) : r.duration({
                days: t.asDays() * e
            }))
        ...
        o.mergeProps = function t(e, n) {
            ...
            if (n)
                for (r = 0; r < n.length; r++) {
                    for (i = n[r], o = [], s = e.length - 1; 0 <= s; s--)
            ...
            var u = function() {
                var t = +new Date - a;
                t < n ? i = setTimeout(u, n - t) : (i = null, r || (l = e.apply(s, o), s = o = null))
            };
            return function() {
                s = this, o = arguments, a = +new Date;
                var t = r && !i;
                return i || (i = setTimeout(u, n)), t && (l = e.apply(s, o), s = o = null), l
            }
        }
    }, function(t, e, n) {
        ...
        var r = n(0),
            ...
            o = function() {
                ...
                return s.invertRanges = function(t, e) {
                    var n, r, i = [],
                        o = e.startMs;
                    for (t.sort(a), n = 0; n < t.length; n++)(r = t[n]).startMs > o && i.push(new s(o, r.startMs)), r.endMs > o && (o = r.endMs);
                    return o < e.endMs && i.push(new s(o, e.endMs)), i
                }, s.prototype.intersect = function(t) {
                    var e = this.startMs,
                        n = this.endMs,
                        r = null;
                    return null != t.startMs && (e = null == e ? t.startMs : Math.max(e, t.startMs)), null != t.endMs && (n = null == n ? t.endMs : Math.min(n, t.endMs)), (null == e || null == n || e < n) && ((r = new s(e, n)).isStart = this.isStart && e === this.startMs, r.isEnd = this.isEnd && n === this.endMs), r
        ...
        var i = n(2),
            ...
            l = function(n) {
                function r(t) {
                    ...
                    return e.calendar = t, e.className = [], e.uid = String(r.uuid++), e
                }
                return i.__extends(r, n), r.parse = function(t, e) {
                    var n = new this(e);
                    return !("object" != typeof t || !n.applyProps(t)) && n
                }, r.normalizeId = function(t) {
                    return t ? String(t) : null
                }, r.prototype.fetch = function(t, e, n) {}, r.prototype.removeEventDefsById = function(t) {}, r.prototype.removeAllEventDefs = function() {}, r.prototype.getPrimitive = function(t) {}, r.prototype.parseEventDefs = function(t) {
                    var e, n, r = [];
                    ...
                    return null != t.id && (this.id = r.normalizeId(t.id)), o.isArray(t.className) ? this.className = t.className : "string" == typeof t.className && (this.className = t.className.split(/\s+/)), !0
                }, r.uuid = 0, r.defineStandardProps = s.default.defineStandardProps, r.copyVerbatimStandardProps = s.default.copyVerbatimStandardProps, r
            }(r.default);
        ...
        function a(t, e, n) {
            ...
            return u.isMoment(a) || c.isNativeDate(a) || void 0 === a ? s = u.apply(null, t) : (i = r = !1, l ? p.test(a) ? (t = [a += "-01"], i = r = !0) : (o = h.exec(a)) && (r = !o[5], i = !0) : d.isArray(a) && (i = !0), s = e || r ? u.utc.apply(u, t) : u.apply(null, t), r ? (s._ambigTime = !0, s._ambigZone = !0) : n && (i ? s._ambigZone = !0 : l && s.utcOffset(a))), s._fullCalendar = !0, s
            ...
            if (!this._fullCalendar) return i.time.apply(this, arguments);
            ...
            return i.local.call(this, this._ambigZone || t), this._ambigTime = !1, this._ambigZone = !1, this
        }, r.utc = function(t) {
            return i.utc.call(this, t), this._ambigTime = !1, this._ambigZone = !1, this
        }, r.utcOffset = function(t) {
            return null != t && (this._ambigTime = !1, this._ambigZone = !1), i.utcOffset.apply(this, arguments)
        }
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var r = n(2),
            ...
            o = function(t) {
                ...
                return r.__extends(e, t), e.prototype.on = function(t, e) {
                    ...
                    return n.guid || (n.guid = i.guid++), t.guid = n.guid, t
        ...
        var i = n(2),
            ...
            a = function(r) {
                ...
                return i.__extends(t, r), t.prototype.buildInstances = function() {
        ...
        var r = n(5),
            i = function() {
                ...
                return u.parse = function(t, e) {
                    ...
                    return !!o.isValid() && (!s || s.isValid() && s.isAfter(o) || (s = null), null == a && null == (a = e.allDayDefault) && (a = i.opt("allDayDefault")), !0 === a ? (o.stripTime(), s && s.stripTime()) : !1 === a && (o.hasTime() || o.time(0), s && !s.hasTime() && s.time(0)), !s && l && (s = i.getDefaultEventEnd(!o.hasTime(), o)), new u(o, s, i))
            ...
            o = function() {
                ...
                return t.prototype.getAllEventRanges = function(t) {
                    ...
                    var e, n, r, i = this.eventInstances,
                        o = [];
                    for (e = 0; e < i.length; e++)(r = (n = i[e]).dateProfile.unzonedRange.intersect(t)) && o.push(new s.default(r, n.def, n));
                    return o
        ...
        (e.default = i).prototype.classes = {}, i.prototype.iconClasses = {}, i.prototype.baseIconClass = "", i.prototype.iconOverridePrefix = ""
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var r = e(16);
        n.viewHash = {}, r.views = n.viewHash, n.defineView = function(t, e) {
            n.viewHash[t] = e
        ...
        var r = n(2),
            ...
            i = function(o) {
                ...
                return r.__extends(t, o), t.prototype.handleInteractionStart = function(t) {
                    ...
                    this.component.hitsNeeded(), this.computeScrollBounds(), t ? (r = n = {
                        left: s.getEvX(t),
                        top: s.getEvY(t)
                    }, i && (e = s.getOuterRect(i), r = s.constrainPoint(r, e)), this.origHit = this.queryHit(r.left, r.top), i && this.options.subjectCenter && (this.origHit && (e = s.intersectRects(this.origHit, e) || e), r = s.getRectCenter(e)), this.coordAdjust = s.diffPoints(r, n)) : (this.origHit = null, this.coordAdjust = null), o.prototype.handleInteractionStart.call(this, t)
                    ...
                    var r;
                    o.prototype.handleDrag.call(this, t, e, n), a(r = this.queryHit(s.getEvX(n), s.getEvY(n)), this.hit) || (this.hit && this.handleHitOut(), r && this.handleHitOver(r))
        ...
        var s = e(3),
            ...
            i = e(32),
            a = e(4);
        o.localeOptionHash = {}, r.locales = o.localeOptionHash;
        var l = {
        ...
        function c(t, e) {
            var n, r;
            n = o.localeOptionHash[t] || (o.localeOptionHash[t] = {}), e && (n = o.localeOptionHash[t] = i.mergeOptions([n, e])), r = p(t), s.each(u, function(t, e) {
                null == n[t] && (n[t] = e(r, n))
        ...
        o.populateInstanceComputableOptions = function(n) {
            ...
            r.isRTL = n.isRTL, r.weekNumberTitle = n.weekHeader, s.each(l, function(t, e) {
                r[t] = e(n)
            });
            var i = s.datepicker;
            i && (i.regional[e] = i.regional[t] = n, i.regional.en = i.regional[""], i.setDefaults(n))
        }, o.locale = c, o.getMomentLocaleData = p, c("en", i.englishDefaults)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var r = n(3),
            ...
            o = function() {
                ...
                return e.parse = function(t, e) {
                    ...
                    return t.id = this.id, t.rawId = this.rawId, t.uid = this.uid, e.copyVerbatimStandardProps(this, t), t.className = this.className.slice(), t.miscProps = r.extend({}, this.miscProps), t
                    ...
                    return null != t.id ? this.id = e.normalizeId(this.rawId = t.id) : this.id = e.generateId(), null != t._id ? this.uid = String(t._id) : this.uid = e.generateId(), r.isArray(t.className) && (this.className = t.className), "string" == typeof t.className && (this.className = t.className.split(/\s+/)), !0
                }, e.prototype.applyMiscProps = function(t) {
                    r.extend(this.miscProps, t)
                }, e.uuid = 0, e.defineStandardProps = i.default.defineStandardProps, e.copyVerbatimStandardProps = i.default.copyVerbatimStandardProps, e
            }();
            ...
            i = function() {
                ...
                return f.createFromRawProps = function(t, e, n) {
                    var r, i, o, s, a = t.def,
                        ...
                        p = null,
                        h = null;
                    for (r in e) v.default.isStandardProp(r) ? l[r] = e[r] : a.isStandardProp(r) ? u[r] = e[r] : a.miscProps[r] !== e[r] && (d[r] = e[r]);
                    return (i = v.default.parse(l, a.source)) && (o = m.default.createFromDiff(t.dateProfile, i, n)), u.id !== a.id && (p = u.id), g.isArraysEqual(u.className, a.className) || (h = u.className), y.default.copyVerbatimStandardProps(u, c), (s = new f).eventDefId = p, s.className = h, s.verbatimStandardProps = c, s.miscProps = d, o && (s.dateMutation = o), s
        ...
        var r = n(2),
            ...
            s = function(n) {
                ...
                return r.__extends(t, n), t.prototype.render = function() {
        ...
        var i = n(2),
            ...
            l = function(r) {
                ...
                return i.__extends(t, r), t.prototype.setElement = function(t) {
                    r.prototype.setElement.call(this, t), this.dateClicking && this.dateClicking.bindToEl(t), this.dateSelecting && this.dateSelecting.bindToEl(t), this.bindAllSegHandlersToEl(t)
                }, t.prototype.removeElement = function() {
                    this.endInteractions(), r.prototype.removeElement.call(this)
                }, t.prototype.executeEventUnrender = function() {
                    this.endInteractions(), r.prototype.executeEventUnrender.call(this)
                }, t.prototype.bindGlobalHandlers = function() {
                    r.prototype.bindGlobalHandlers.call(this), this.externalDropping && this.externalDropping.bindToDocument()
                }, t.prototype.unbindGlobalHandlers = function() {
                    r.prototype.unbindGlobalHandlers.call(this), this.externalDropping && this.externalDropping.unbindFromDocument()
                }, t.prototype.bindDateHandlerToEl = function(t, e, n) {
                    var r = this;
                    this.el.on(e, function(t) {
                        if (!o(t.target).is(r.segSelector + ":not(.fc-helper)," + r.segSelector + ":not(.fc-helper) *,.fc-more,a[data-goto]")) return n.call(r, t)
                    })
                    ...
                    t.on(e, this.segSelector, function(t) {
                        ...
                        if (!e.is(".fc-helper")) {
                            var n = e.data("fc-seg");
                            if (n && !i.shouldIgnoreEventPointing()) return r.call(i, n, t)
                        }
                    })
                }, t.prototype.shouldIgnoreMouse = function() {
        ...
        var i = n(2),
            ...
            p = function(r) {
                ...
                return i.__extends(t, r), t.prototype._getView = function() {
                    return this
                    ...
                    r.prototype.executeDateRender.call(this, t), this.render && this.render(), this.trigger("datesRendered"), this.addScroll({
                        isDateInit: !0
                    }), this.startNowIndicator()
                }, t.prototype.executeDateUnrender = function() {
                    this.unselect(), this.stopNowIndicator(), this.trigger("before:datesUnrendered"), this.destroy && this.destroy(), r.prototype.executeDateUnrender.call(this)
                    ...
                    r.prototype.bindGlobalHandlers.call(this), this.listenTo(d.default.get(), {
                        touchstart: this.processUnselect,
                        mousedown: this.handleDocumentMousedown
                    })
                }, t.prototype.unbindGlobalHandlers = function() {
                    r.prototype.unbindGlobalHandlers.call(this), this.stopListeningTo(d.default.get())
                    ...
                    this.opt("nowIndicator") && (t = this.getNowIndicatorUnit()) && (e = a.proxy(this, "updateNowIndicator"), this.initialNowDate = this.calendar.getNow(), this.initialNowQueriedMs = (new Date).valueOf(), n = this.initialNowDate.clone().startOf(t).add(1, t).valueOf() - this.initialNowDate.valueOf(), this.nowIndicatorTimeoutID = setTimeout(function() {
                        r.nowIndicatorTimeoutID = null, e(), n = +s.duration(1, t), n = Math.max(100, n), r.nowIndicatorIntervalID = setInterval(e, n)
                    }, n))
                    ...
                    this.setHeight ? this.setHeight(t, e) : r.prototype.updateSize.call(this, t, e, n), this.updateNowIndicator()
                    ...
                    return {}
                }, t.prototype.applyDateScroll = function(t) {}, t.prototype.reportEventDrop = function(t, e, n, r) {
                    var i = this.calendar.eventManager.mutateEventsWithId(t.def.id, e),
                        o = e.dateMutation;
                    o && (t.dateProfile = o.buildNewDateProfile(t.dateProfile, this.calendar)), this.triggerEventDrop(t, o && o.dateDelta || s.duration(), i, n, r)
                    ...
                    var t, e = this.opt("hiddenDays") || [],
                        n = [],
                        r = 0;
                    for (!1 === this.opt("weekends") && e.push(0, 6), t = 0; t < 7; t++)(n[t] = -1 !== o.inArray(t, e)) || r++;
        ...
        (e.default = p).prototype.usesMinMaxTime = !1, p.prototype.dateProfileGeneratorClass = r.default, p.watch("displayingDates", ["isInDom", "dateProfile"], function(t) {
            ...
            r = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var e, s = this.view.hasPublicHandlers("eventRender"),
                        ...
                        a = [];
                    if (i.length) {
                        for (e = 0; e < i.length; e++) this.beforeFgSegHtml(i[e]), n += this.fgSegHtml(i[e], t);
                        l(n).each(function(t, e) {
                            var n = i[t],
                                r = l(e);
                            s && (r = o.filterEventRenderEl(n.footprint, r)), r && (r.data("fc-seg", n), n.el = r, a.push(n))
                        })
                    }
                    return a
                    ...
                    return !1 === r ? e = null : r && !0 !== r && (e = l(r)), e
        ...
        e.formatDate = c, e.formatRange = function(t, e, n, r, i) {
            return t = s.default.parseZone(t), e = s.default.parseZone(e),
                function(t, e, n, r, i) {
                    ...
                    return (g || v) && (y = i ? v + r + g : g + r + v), b(h + y + f)
        ...
        function h(t) {
            return p[t] || (p[t] = {
                    fakeFormatString: function t(e) {
                        var n, r, i = [];
                        for (n = 0; n < e.length; n++) "string" == typeof(r = e[n]) ? i.push("[" + r + "]") : r.token ? r.token in u ? i.push(l + "[" + r.token + "]") : i.push(r.token) : r.maybe && i.push(o + t(r.maybe) + o);
                        return i.join(a)
                    }(e = f(t)),
                    sameUnits: function t(e) {
                        var n, r, i, o = [];
                        for (n = 0; n < e.length; n++)(r = e[n]).token ? (i = d[r.token.charAt(0)], o.push(i ? i.unit : "second")) : r.maybe ? o.push.apply(o, t(r.maybe)) : o.push(null);
                        return o
                    }(e)
                });
            var e
        ...
        function m(t, e) {
            ...
            for (n = 0; n < o.length; n++)(r = o[n]).charAt(0) === l ? i.push(u[r.substring(1)](e)) : i.push(r);
            return i
        }
        ...
        var r = n(2),
            ...
            a = function(e) {
                ...
                return r.__extends(t, e), t.watch = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    ...
                    this.unwatch(n), this._watchers[n] = this._watchDeps(t, function(t) {
                        var e = r.call(i, t);
                        e && e.then ? (i.unset(n), e.then(function(t) {
                            i.set(n, t)
                        })) : i.set(n, e)
                    }, function(t) {
                        i.unset(n), e && e.call(i, t)
                    })
                    ...
                    return t.forEach(function(i) {
                        var o = !1;
                        "?" === i.charAt(0) && (i = i.substring(1), o = !0), p("before:change:" + i, function(t) {
                            1 == ++a && u === l && (c = !0, e(d), c = !1)
                        }), p("change:" + i, function(t) {
                            var e, n, r;
                            e = i, r = o, void 0 === (n = t) ? (r || void 0 === d[e] || u--, delete d[e]) : (r || void 0 !== d[e] || u++, d[e] = n), --a || u === l && (c || s(d))
                        })
                        ...
                        teardown: function() {
                            for (var t = 0; t < r.length; t++) n.off(r[t][0], r[t][1]);
                            r = null, u === l && e()
                        },
                        flash: function() {
                            u === l && (e(), s(d))
        ...
        var r = n(2),
            ...
            u = function(n) {
                ...
                return r.__extends(t, n), t.parse = function(t, e) {
                    var n;
        ...
        var r = n(3),
            ...
            s = function() {
                ...
                return t.prototype.startInteraction = function(t, e) {
                    ...
                    this.isInteracting && (this.endDrag(t), this.delayTimeoutId && (clearTimeout(this.delayTimeoutId), this.delayTimeoutId = null), this.destroyAutoScroll(), this.unbindHandlers(), this.isInteracting = !1, this.handleInteractionEnd(t, e), u.allowSelection(r("body")))
                }, t.prototype.handleInteractionEnd = function(t, e) {
                    ...
                    this.stopListeningTo(o.default.get()), this.stopListeningTo(r(document))
                    ...
                    var e = u.getEvX(t) - this.originX,
                        ...
                        r = this.minDistance;
                    this.isDistanceSurpassed || r * r <= e * e + n * n && this.handleDistanceSurpassed(t), this.isDragging && this.handleDrag(e, n, t)
                }, t.prototype.handleDrag = function(t, e, n) {
                    ...
                    var e, n, r, i, o = this.scrollSensitivity,
                        s = this.scrollBounds,
                        a = 0,
                        l = 0;
                    s && (e = (o - (u.getEvY(t) - s.top)) / o, n = (o - (s.bottom - u.getEvY(t))) / o, r = (o - (u.getEvX(t) - s.left)) / o, i = (o - (s.right - u.getEvX(t))) / o, 0 <= e && e <= 1 ? a = e * this.scrollSpeed * -1 : 0 <= n && n <= 1 && (a = n * this.scrollSpeed), 0 <= r && r <= 1 ? l = r * this.scrollSpeed * -1 : 0 <= i && i <= 1 && (l = i * this.scrollSpeed)), this.setScrollVel(a, l)
        ...
        e.default = s, i.default.mixInto(s)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
            ...
            r = function() {
                ...
                return t.prototype.renderFootprint = function(t, e, n) {
                    ...
                    var e, s = this,
                        ...
                        a = [];
                    if (i.length) {
                        for (e = 0; e < i.length; e++) n += this.buildSegHtml(t, i[e], o);
                        l(n).each(function(t, e) {
                            var n = i[t],
                                r = l(e);
                            o.filterEl && (r = o.filterEl(n, r)), r && (r = l(r)).is(s.fillSegTag) && (n.el = r, a.push(n))
                        })
                    }
                    return a
            ...
            r = function() {
                ...
                return t.prototype.renderComponentFootprint = function(t) {
                    ...
                    var e, n = this.view.calendar,
                        r = n.footprintToDateProfile(t),
                        i = new o.default(new a.default(n));
                    return i.dateProfile = r, e = i.buildInstance(), new s.default(t, i, e)
                }, t
            }();
        e.default = r
    }, function(t, e, n) {
        ...
        var r = n(2),
            ...
            y = function(n) {
                ...
                return r.__extends(t, n), t.prototype.componentFootprintToSegs = function(t) {
                    ...
                    var e, n, r, i = this.rowEls.eq(t).height(),
                    ...
                    for (e = 0; e < o.length; e++)
                        if (n = o.eq(e).removeClass("fc-limited"), r = 0, n.find("> td > :first-child").each(s), n.position().top + r > i) return e;
                    return !1
                }, t.prototype.limitRow = function(e, n) {
                    var t, r, i, o, s, a, l, u, d, c, p, h, f, g, v, y = this,
                        m = this.eventRenderer.rowStructs[e],
                        b = [],
                        w = 0,
                        D = function(t) {
                            for (; w < t;)(a = y.getCellSegs(e, w, n)).length && (d = r[n - 1][w], v = y.renderMoreLink(e, w, a), g = E("<div/>").append(v), d.append(g), b.push(g[0])), w++
                        };
                    if (n && n < m.segLevels.length) {
                        for (t = m.segLevels[n - 1], r = m.cellMatrix, i = m.tbodyEl.children().slice(n).addClass("fc-limited").get(), o = 0; o < t.length; o++) {
                            for (D((s = t[o]).leftCol), u = [], l = 0; w <= s.rightCol;) a = this.getCellSegs(e, w, n), u.push(a), l += a.length, w++;
                            if (l) {
                                for (c = (d = r[n - 1][s.leftCol]).attr("rowspan") || 1, p = [], h = 0; h < u.length; h++) f = E('<td class="fc-more-cell"/>').attr("rowspan", c), a = u[h], v = this.renderMoreLink(e, s.leftCol + h, [s].concat(a)), g = E("<div/>").append(v), f.append(g), p.push(f[0]), b.push(f[0]);
                                d.addClass("fc-limited").after(E(p)), i.push(d[0])
                            }
                        }
                        D(this.colCnt), m.moreEls = E(b), m.limitedEls = E(i)
                    }
                    ...
                    var i, o, s = this,
                        a = this.view,
                        l = n.parent();
                    i = 1 === this.rowCnt ? a.el : this.rowEls.eq(t), o = {
                    ...
                    }, this.isRTL ? o.right = l.offset().left + l.outerWidth() + 1 : o.left = l.offset().left - 1, this.segPopover = new u.default(o), this.segPopover.show(), this.bindAllSegHandlersToEl(this.segPopover.el), this.triggerAfterEventSegsRendered(r)
                }, t.prototype.renderSegPopoverContent = function(t, e, n) {
                    var r, i = this.view.calendar.theme,
                        o = this.getCellDate(t, e).format(this.opt("dayPopoverFormat")),
                        s = E('<div class="fc-header ' + i.getClass("popoverHeader") + '"><span class="fc-close ' + i.getIconClass("close") + '"></span><span class="fc-title">' + l.htmlEscape(o) + '</span><div class="fc-clear"/></div><div class="fc-body ' + i.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>'),
                        a = s.find(".fc-event-container");
                    for (n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, r = 0; r < n.length; r++) this.hitsNeeded(), n[r].hit = this.getCellHit(t, e), this.hitsNotNeeded(), a.append(n[r].el);
                    return s
                    ...
                    var n, r, i, o = e.clone(),
                        ...
                        a = new d.default(o, s),
                        l = [];
                    for (n = 0; n < t.length; n++)(i = (r = t[n]).footprint.componentFootprint.unzonedRange.intersect(a)) && l.push(E.extend({}, r, {
        ...
        (e.default = y).prototype.eventRendererClass = f.default, y.prototype.businessHourRendererClass = i.default, y.prototype.helperRendererClass = g.default, y.prototype.fillRendererClass = v.default, o.default.mixInto(y), h.default.mixInto(y)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var r = n(2),
            ...
            d = function(a) {
                ...
                return r.__extends(t, a), t.prototype.instantiateDayGrid = function() {
                    return new(function(e) {
                        function t() {
                            var t = null !== e && e.apply(this, arguments) || this;
                            return t.colWeekNumbersVisible = !1, t
                        }
                        return r.__extends(t, e), t.prototype.renderHeadIntroHtml = function() {
                            var t = this.view;
            ...
            a = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var e, n = t.getEventDef(),
                        ...
                        i = this.getPeerEventInstances(n).map(u.eventInstanceToEventRange),
                        o = this.eventRangesToEventFootprints(i),
                        s = n.getConstraint(),
                        a = n.getOverlap(),
                        l = this.opt("eventAllow");
                    for (e = 0; e < r.length; e++)
                        if (!this.isFootprintAllowed(r[e].componentFootprint, o, s, a, r[e].eventInstance)) return !1;
                    if (l)
                        for (e = 0; e < r.length; e++)
                            if (!1 === l(r[e].componentFootprint.toLegacy(this._calendar), r[e].getEventLegacy())) return !1;
                    return !0
        ...
        var r = n(2),
            ...
            a = function(e) {
                ...
                return r.__extends(t, e), t.prototype.isAllDay = function() {
                    return !this.startTime && !this.endTime
                }, t.prototype.buildInstances = function(t) {
                    for (var e, n, r, i = this.source.calendar, o = t.getStart(), s = t.getEnd(), a = []; o.isBefore(s);) this.dowHash && !this.dowHash[o.day()] || (n = (e = i.applyTimezone(o)).clone(), r = null, this.startTime ? n.time(this.startTime) : n.stripTime(), this.endTime && (r = e.clone().time(this.endTime)), a.push(new l.default(this, new u.default(n, r, i)))), o.add(1, "days");
                    return a
                    ...
                    return t.startTime && (t.startTime = o.duration(this.startTime)), t.endTime && (t.endTime = o.duration(this.endTime)), this.dowHash && (t.dowHash = i.extend({}, this.dowHash)), t
                }, t
            }(s.default);
            ...
            u = function() {
                ...
                return t.prototype.buildEventInstanceGroup = function(t, e) {
                    ...
                    var e, n = this.rawComplexDef,
                        ...
                        i = !1,
                        o = [];
                    for (!0 === n ? r = [{}] : s.isPlainObject(n) ? r = [n] : s.isArray(n) && (r = n, i = !0), e = 0; e < r.length; e++) i && !r[e].dow || o.push(this.buildEventDef(t, r[e]));
                    return o
                }, t.prototype.buildEventDef = function(t, e) {
                    var n = s.extend({}, l, e);
                    return t && (n.start = null, n.end = null), r.default.parse(n, new a.default(this.calendar))
                }, t
            }();
        e.default = u
    }, function(t, e, n) {
                ...
                return r.__extends(t, n), t.parse = function(t, e) {
                    ...
                    return this.calendar.pushLoading(), o.default.construct(function(e) {
                        i.func.call(i.calendar, t.clone(), n.clone(), r, function(t) {
                            i.calendar.popLoading(), e(i.parseEventDefs(t))
                        })
                    })
                }, t.prototype.getPrimitive = function() {
                    return this.func
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(d, t), d.parse = function(t, e) {
                    var n;
                    ...
                    return this.calendar.pushLoading(), i.default.construct(function(i, o) {
                        c.ajax(c.extend({}, d.AJAX_DEFAULTS, r, {
                            url: s.url,
                            data: u,
                            success: function(t, e, n) {
                                var r;
                                s.calendar.popLoading(), t ? (r = p.applyAll(a, s, [t, e, n]), c.isArray(r) && (t = r), i(s.parseEventDefs(t))) : o()
                            },
                    ...
                    var r, i, o, s, a = this.calendar,
                        l = this.ajaxSettings,
                        u = {};
                    return null == (r = this.startParam) && (r = a.opt("startParam")), null == (i = this.endParam) && (i = a.opt("endParam")), null == (o = this.timezoneParam) && (o = a.opt("timezoneParam")), s = c.isFunction(l.data) ? l.data() : l.data || {}, c.extend(u, s), u[r] = t.format(), u[i] = e.format(), n && "local" !== n && (u[o] = n), u
        ...
        var r = n(2),
            i = function(n) {
                ...
                return r.__extends(t, n), t.prototype.queue = function(t, e, n) {
                    var r, i = {
                        func: t,
                        namespace: e,
                        type: n
        ...
        var o = n(2),
            ...
            i = function(r) {
                ...
                return o.__extends(i, r), i.prototype.addChild = function(t) {
                ...
                }, i.prototype.renderDates = function(t) {}, i.prototype.unrenderDates = function() {}, i.prototype.getNowIndicatorUnit = function() {}, i.prototype.renderNowIndicator = function(t) {
                ...
                }, i.prototype.prepareHits = function() {}, i.prototype.releaseHits = function() {}, i.prototype.queryHit = function(t, e) {
                ...
                }, i.prototype.getHitFootprint = function(t) {}, i.prototype.getHitEl = function(t) {}, i.prototype.eventRangesToEventFootprints = function(t) {
                    var e, n = [];
                    for (e = 0; e < t.length; e++) n.push.apply(n, this.eventRangeToEventFootprints(t[e]));
                    return n
                    ...
                    var r, i, o, s;
                    return a.isPlainObject(t) ? (r = t.date, i = t.type, o = t.forceOff) : r = t, s = {
                    ...
                    var n, r = this._getView(),
                        i = [];
                    return this.dateProfile.activeUnzonedRange.containsDate(t) ? (i.push("fc-" + l.dayIDs[t.day()]), r.isDateInOtherMonth(t, this.dateProfile) && i.push("fc-other-month"), n = r.calendar.getNow(), t.isSame(n, "day") ? (i.push("fc-today"), !0 !== e && i.push(r.calendar.theme.getClass("today"))) : t < n ? i.push("fc-past") : i.push("fc-future")) : i.push("fc-disabled-day"), i
                }, i.prototype.formatRange = function(t, e, n, r) {
                    var i = t.end;
                    return e && (i = i.clone().subtract(1)), d.formatRange(t.start, i, n, r, this.isRTL)
        ...
        var s = n(3),
            ...
            I = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    if (s.isPlainObject(e) ? (n = e.context, r = e.args) : s.isArray(e) && (r = e), null == n && (n = this.el[0]), r || (r = []), this.triggerWith(t, n, r), i) return i.apply(n, r)
                    ...
                    this.currentDate.add(r.duration(t)), this.renderView()
                    ...
                    var o = this,
                        r = this.el;
                    r.addClass("fc"), r.on("click.fc", "a[data-goto]", function(t) {
                        var e = s(t.currentTarget).data("goto"),
                            n = o.moment(e.date),
                            r = e.type,
                            i = o.view.opt("navLink" + a.capitaliseFirstLetter(r) + "Click");
                        "function" == typeof i ? i(n, t) : ("string" == typeof i && (r = i), o.zoomTo(n, r))
                        ...
                        var e = new(M.getThemeSystemClass(t.themeSystem || t.theme))(o.optionsManager),
                            n = e.getClass("widget");
                        o.theme = e, n && r.addClass(n)
                    }, function() {
                        var t = o.theme.getClass("widget");
                        o.theme = null, t && r.removeClass(t)
                        ...
                        r.toggleClass("fc-ltr", !t.isRTL), r.toggleClass("fc-rtl", t.isRTL)
                    }), this.contentEl = s("<div class='fc-view-container'/>").prependTo(r), this.initToolbars(), this.renderHeader(), this.renderFooter(), this.renderView(this.opt("defaultView")), this.opt("handleWindowResize") && s(window).resize(this.windowResizeProxy = a.debounce(this.windowResize.bind(this), this.opt("windowResizeDelay")))
                }, t.prototype.destroy = function() {
                    ...
                    this.defaultAllDayEventDuration = r.duration(this.opt("defaultAllDayEventDuration")), this.defaultTimedEventDuration = r.duration(this.opt("defaultTimedEventDuration")), this.optionsManager.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function(t) {
                        ...
                        t.monthNames && (i._months = t.monthNames), t.monthNamesShort && (i._monthsShort = t.monthNamesShort), t.dayNames && (i._weekdays = t.dayNames), t.dayNamesShort && (i._weekdaysShort = t.dayNamesShort), null == r && "ISO" === n && (r = 1), null != r && ((e = Object.create(i._week)).dow = r, i._week = e), "ISO" !== n && "local" !== n && "function" != typeof n || (i._fullCalendar_weekCalc = n), o.localeData = i, o.currentDate && o.localizeMoment(o.currentDate)
                    })
                    ...
                    var n = this,
                        ...
                        e = this.opt("events");
                    this.eventManager = r, e && t.unshift(e), r.on("release", function(t) {
                        n.trigger("eventsReset", t)
                    }), r.freeze(), t.forEach(function(t) {
                    ...
                    n.thaw()
                }, t.defaults = i.globalDefaults, t.englishDefaults = i.englishDefaults, t.rtlDefaults = i.rtlDefaults, t
            }();
            ...
            r = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var n, r = this._view.viewSpec,
                        ...
                        o = null,
                        s = null;
                    return r.duration ? (i = r.duration, o = r.durationUnit, s = this.buildRangeFromDuration(t, e, i, o)) : (n = this.opt("dayCount")) ? (o = "day", s = this.buildRangeFromDayCount(t, e, n)) : (s = this.buildCustomVisibleRange(t)) ? o = c.computeGreatestUnit(s.getStart(), s.getEnd()) : (i = this.getFallbackDuration(), o = c.computeGreatestUnit(i), s = this.buildRangeFromDuration(t, e, i, o)), {
                        duration: i,
                        unit: o,
                        unzonedRange: s
                    }
                    ...
                    var r = t.getStart(),
                        i = t.getEnd();
                    return this._view.usesMinMaxTime && (e < 0 && r.time(0).add(e), 864e5 < n && i.time(n - 864e5)), new h.default(r, i)
                    ...
                    return u || ((i = this.opt("dateIncrement")) ? (o = p.duration(i), u = o < n ? c.computeDurationGreatestUnit(o, i) : r) : u = r), n.as("days") <= 1 && this._view.isHiddenDay(s) && (s = this._view.skipHiddenDays(s, e)).startOf("day"), d(), this.trimHiddenDays(l) || (t = this._view.skipHiddenDays(t, e), d()), l
                }, t.prototype.buildRangeFromDayCount = function(t, e, n) {
                    var r, i = this.opt("dateAlignment"),
                        o = 0,
                        s = t.clone();
                    for (i && s.startOf(i), s.startOf("day"), r = (s = this._view.skipHiddenDays(s, e)).clone(); r.add(1, "day"), this._view.isHiddenDay(r) || o++, o < n;);
        ...
        var r = n(2),
            ...
            l = function(e) {
                ...
                return r.__extends(t, e), t.prototype.end = function() {
                    ...
                    var n, r;
                    this.opt("droppable") && (n = u((e ? e.item : null) || t.target), r = this.opt("dropAccept"), (u.isFunction(r) ? r.call(n[0], n) : n.is(r)) && (this.isDragging || this.listenToExternalDrag(n, t, e)))
                    ...
                    var i, o = this,
                        ...
                        l = function(t) {
                            ...
                            o && (o += "-");
                            (e = t.data(o + "event") || null) && (e = "object" == typeof e ? u.extend({}, e) : {}, null == (n = e.start) && (n = e.time), r = e.duration, i = e.stick, delete e.start, delete e.time, delete e.duration, delete e.stick);
                            null == n && (n = t.data(o + "start"));
                            null == n && (n = t.data(o + "time"));
                            null == r && (r = t.data(o + "duration"));
                            null == i && (i = t.data(o + "stick"));
                            return n = null != n ? d.duration(n) : null, r = null != r ? d.duration(r) : null, i = Boolean(i), {
                                eventProps: e,
                                startTime: n,
                                duration: r,
                                stick: i
                    ...
                    (this.dragListener = new h.default(s, {
                        ...
                        hitOver: function(t) {
                            ...
                            r && (i = o.computeExternalDrop(r, l)) ? (e = new f.default(i.buildInstances()), n = l.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e)) : n = !1, n || (i = null, p.disableCursor()), i && s.renderDrag(s.eventRangesToEventFootprints(e.sliceRenderRanges(s.dateProfile.renderUnzonedRange, a.calendar)))
                        },
                        hitOut: function() {
                            i = null
                        },
                        ...
                        interactionEnd: function(t) {
                            i && a.reportExternalDrop(i, Boolean(l.eventProps), Boolean(l.stick), e, t, n), o.isDragging = !1, o.dragListener = null
                        }
                    })).startDrag(t)
                }, t.prototype.computeExternalDrop = function(t, e) {
                    var n, r = this.view.calendar,
                        i = o.default.utc(t.unzonedRange.startMs).stripZone();
                    return t.isAllDay && (e.startTime ? i.time(e.startTime) : i.stripTime()), e.duration && (n = i.clone().add(e.duration)), i = r.applyTimezone(i), n && (n = r.applyTimezone(n)), s.default.parse(u.extend({}, e.eventProps, {
                        start: i,
                        end: n
                    }), new a.default(r))
                }, t
            }(n(15).default);
        e.default = l, i.default.mixInto(l), c.dataAttrPrefix = ""
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var i = n(2),
            ...
            r = function(r) {
                ...
                return i.__extends(t, r), t.prototype.end = function() {
                    this.dragListener && this.dragListener.endInteraction()
                    ...
                    return this.dragListener = new s.default(c, {
                        ...
                        hitOver: function(t, e, n) {
                            ...
                            o && s && (u = l ? d.computeEventStartResizeMutation(o, s, a.footprint) : d.computeEventEndResizeMutation(o, s, a.footprint)) ? (r = f.buildMutatedEventInstanceGroup(g.id, u), i = c.isEventInstanceGroupAllowed(r)) : i = !1, i ? u.isEmpty() && (u = null) : (u = null, v.disableCursor()), u && (p.hideEventsWithId(a.footprint.eventDef.id), p.renderEventResize(c.eventRangesToEventFootprints(r.sliceRenderRanges(c.dateProfile.renderUnzonedRange, h)), a))
                        },
                        hitOut: function() {
                            u = null
                        },
                        ...
                        interactionEnd: function(t) {
                            e && d.segResizeStop(a, t), u && p.reportEventResize(r, u, n, t), d.dragListener = null
                        }
                    })
                    ...
                    return o.getStart().add(s) < o.getEnd() && ((r = new l.default).setStartDelta(s), (i = new a.default).setDateMutation(r), i)
                    ...
                    return o.getEnd().add(s) > o.getStart() && ((r = new l.default).setEndDelta(s), (i = new a.default).setDateMutation(r), i)
                }, t
            }(n(15).default);
        e.default = r
    }, function(t, e, n) {
            ...
            r = function(r) {
                ...
                return i.__extends(t, r), t.prototype.end = function() {
                    ...
                    var v = this.dragListener = new m.default(p, {
                        ...
                        dragStart: function(t) {
                            v.isTouch && !p.isEventDefSelected(g) && r && p.selectEventInstance(r), e = !0, d.eventPointing.handleMouseout(a, t), d.segDragStart(a, t), p.hideEventsWithId(a.footprint.eventDef.id)
                        },
                        hitOver: function(t, e, n) {
                            var r, i, o, s = !0;
                            a.hit && (n = a.hit), r = n.component.getSafeHitFootprint(n), i = t.component.getSafeHitFootprint(t), r && i && (u = d.computeEventDropMutation(r, i, g)) ? (o = f.buildMutatedEventInstanceGroup(g.id, u), s = c.isEventInstanceGroupAllowed(o)) : s = !1, s || (u = null, y.disableCursor()), u && p.renderDrag(c.eventRangesToEventFootprints(o.sliceRenderRanges(c.dateProfile.renderUnzonedRange, h)), a, v.isTouch) ? l.hide() : l.show(), e && (u = null)
                        },
                        hitOut: function() {
                        ...
                        interactionEnd: function(t) {
                            delete a.component, l.stop(!u, function() {
                                e && (p.unrenderDrag(a), d.segDragStop(a, t)), p.showEventsWithId(a.footprint.eventDef.id), u && p.reportEventDrop(r, u, n, t)
                            }), d.dragListener = null
                        }
                    });
                    return v
                    ...
                    var n, r, i = t.unzonedRange.getStart(),
                        ...
                        a = !1,
                        l = !1;
                    return t.isAllDay !== e.isAllDay && (s = !0, e.isAllDay ? (l = !0, i.stripTime()) : a = !0), n = this.component.diffDates(o, i), (r = new u.default).clearEnd = s, r.forceTimed = a, r.forceAllDay = l, r.setDateDelta(n), r
                }, t
            }(n(15).default);
        e.default = r
    }, function(t, e, n) {
        ...
        var r = n(2),
            ...
            a = function(n) {
                ...
                return r.__extends(t, n), t.prototype.end = function() {
                    ...
                    return new i.default(a, {
                        ...
                        hitOver: function(t, e, n) {
                            var r, i;
                            n && (r = a.getSafeHitFootprint(n), i = a.getSafeHitFootprint(t), (o = r && i ? s.computeSelection(r, i) : null) ? a.renderSelectionFootprint(o) : !1 === o && l.disableCursor())
                        },
                        hitOut: function() {
            ...
            h = function(a) {
                ...
                return o.__extends(t, a), t.prototype.instantiateTimeGrid = function() {
                    ...
                    if (a.prototype.updateSize.call(this, t, e, n), this.axisWidth = u.matchCellWidths(this.el.find(".fc-axis")), this.timeGrid.colEls) {
                        ...
                        this.timeGrid.bottomRuleEl.hide(), this.scroller.clear(), u.uncompensateScroll(s), this.dayGrid && (this.dayGrid.removeSegPopover(), (r = this.opt("eventLimit")) && "number" != typeof r && (r = 5), r && this.dayGrid.limitRows(r)), e || (i = this.computeScrollerHeight(t), this.scroller.setHeight(i), ((o = this.scroller.getScrollbarWidths()).left || o.right) && (u.compensateScroll(s, o), i = this.computeScrollerHeight(t), this.scroller.setHeight(i)), this.scroller.lockOverflow(o), this.timeGrid.getTotalSlatHeight() < i && this.timeGrid.bottomRuleEl.show())
                    } else e || (i = this.computeScrollerHeight(t), this.scroller.setHeight(i))
                }, t.prototype.computeScrollerHeight = function(t) {
        ...
        }(e.default = h).prototype.timeGridClass = c.default, h.prototype.dayGridClass = p.default, r = {
        ...
        var i = n(2),
            ...
            m = function(r) {
                ...
                return i.__extends(t, r), t.prototype.componentFootprintToSegs = function(t) {
                    ...
                    for (e = y.length - 1; 0 <= e; e--)
                        if (n = c.duration(y[e]), r = p.divideDurationByDuration(n, t), p.isInt(r) && 1 < r) return n;
                    return c.duration(t)
                }, t.prototype.renderDates = function(t) {
                    ...
                    if (this.colContainerEls) {
                        var e, n = this.componentFootprintToSegs(new h.default(new d.default(t, t.valueOf() + 1), !1)),
                            ...
                            i = [];
                        for (e = 0; e < n.length; e++) i.push(o('<div class="fc-now-indicator fc-now-indicator-line"></div>').css("top", r).appendTo(this.colContainerEls.eq(n[e].col))[0]);
                        0 < n.length && i.push(o('<div class="fc-now-indicator fc-now-indicator-arrow"></div>').css("top", r).appendTo(this.el.find(".fc-content-skeleton"))[0]), this.nowIndicatorEls = o(i)
                    }
                }, t.prototype.unrenderNowIndicator = function() {
                    this.nowIndicatorEls && (this.nowIndicatorEls.remove(), this.nowIndicatorEls = null)
                }, t.prototype.updateSize = function(t, e, n) {
                    r.prototype.updateSize.call(this, t, e, n), this.slatCoordCache.build(), n && this.updateSegVerticals([].concat(this.eventRenderer.getSegs(), this.businessSegs || []))
                    ...
                    return n.time(r), e = n.clone().add(this.snapDuration), new h.default(new d.default(n, e), !1)
        ...
        var r = n(2),
            ...
            i = function(s) {
                ...
                return r.__extends(t, s), t.prototype.buildRenderRange = function(t, e, n) {
                    var r = s.prototype.buildRenderRange.call(this, t, e, n),
                        i = this.msToUtcMoment(r.startMs, n),
                        o = this.msToUtcMoment(r.endMs, n);
                    return /^(year|month)$/.test(e) && (i.startOf("week"), o.weekday() && o.add(1, "week").startOf("week")), new a.default(i, o)
                }, t
            }(n(221).default);
        e.default = i
    }, function(t, e, n) {
        ...
        var i = n(2),
            ...
            c = function(r) {
                ...
                return i.__extends(t, r), t.prototype.renderSkeleton = function() {
                    ...
                    r.prototype.updateSize.call(this, t, e, n), this.scroller.clear(), e || this.scroller.setHeight(this.computeScrollerHeight(t))
                }, t.prototype.computeScrollerHeight = function(t) {
                    ...
                    var e, n, r, i = this.groupSegsByDay(t),
                        o = a('<table class="fc-list-table ' + this.calendar.theme.getClass("tableList") + '"><tbody/></table>'),
                        s = o.find("tbody");
                    for (e = 0; e < i.length; e++)
                        if (n = i[e])
                            for (s.append(this.dayHeaderHtml(this.dayDates[e])), this.eventRenderer.sortEventSegs(n), r = 0; r < n.length; r++) s.append(n[r].el);
        ...
        var l = n(3),
            ...
            u = n(4),
            d = n(220);
        n(10), n(47), n(256), n(257), n(260), n(261), n(262), n(263), l.fullCalendar = r, l.fn.fullCalendar = function(o) {
            var s = Array.prototype.slice.call(arguments, 1),
                a = this;
            return this.each(function(t, e) {
                var n, r = l(e),
                    i = r.data("fullCalendar");
                ...
                return t.prototype.setToolbarOptions = function(t) {
                    ...
                    return n && w.each(n.split(" "), function(t, e) {
                        ...
                        w.each(e.split(","), function(t, e) {
                            ...
                            "title" === e ? (c = c.add(w("<h2>&nbsp;</h2>")), p = !1) : ((n = y[e]) ? (i = function(t) {
                                n.click && n.click.call(u[0], t)
                            }, (o = g.getCustomButtonIconClass(n)) || (o = g.getIconClass(e)) || (s = n.text)) : (r = v.getViewSpec(e)) ? (h.viewsWithButtons.push(e), i = function() {
                                f.changeView(e)
                            }, (s = r.buttonTextOverride) || (o = g.getIconClass(e)) || (s = r.buttonTextDefault)) : f[e] && (i = function() {
                                f[e]()
                            }, (s = m[e]) || (o = g.getIconClass(e)) || (s = b[e])), i && (l = ["fc-" + e + "-button", g.getClass("button"), g.getClass("stateDefault")], s ? (a = D.htmlEscape(s), d = "") : o && (a = "<span class='" + o + "'></span>", d = ' aria-label="' + e + '"'), u = w('<button type="button" class="' + l.join(" ") + '"' + d + ">" + a + "</button>").click(function(t) {
                                u.hasClass(g.getClass("stateDisabled")) || (i(t), (u.hasClass(g.getClass("stateActive")) || u.hasClass(g.getClass("stateDisabled"))) && u.removeClass(g.getClass("stateHover")))
                            }).mousedown(function() {
                        ...
                        }), p && c.first().addClass(g.getClass("cornerLeft")).end().last().addClass(g.getClass("cornerRight")).end(), 1 < c.length ? (n = w("<div/>"), p && n.addClass(g.getClass("buttonGroup")), n.append(c), r.append(n)) : r.append(c)
                    }), r
        ...
        var i = n(2),
            ...
            r = function(r) {
                ...
                return i.__extends(t, r), t.prototype.add = function(t) {
                    var e, n = 0;
                    ...
                    var t, e, n, r;
                    t = s.firstDefined(this.dynamicOverrides.locale, this.overrides.locale), (e = l.localeOptionHash[t]) || (t = a.globalDefaults.locale, e = l.localeOptionHash[t] || {}), n = s.firstDefined(this.dynamicOverrides.isRTL, this.overrides.isRTL, e.isRTL, a.globalDefaults.isRTL) ? a.rtlDefaults : {}, this.dirDefaults = n, this.localeDefaults = e, r = a.mergeOptions([a.globalDefaults, n, e, this.overrides, this.dynamicOverrides]), l.populateInstanceComputableOptions(r), this.reset(r)
            ...
            o = function() {
                ...
                return t.prototype.clearCache = function() {
                    ...
                    if (-1 !== i.inArray(t, h.unitsDesc))
                        for (e = this._calendar.header.getViewsWithButtons(), i.each(p.viewHash, function(t) {
                            e.push(t)
                        }), n = 0; n < e.length; n++)
                            if ((r = this.getViewSpec(e[n])) && r.singleUnit === t) return r
                }, t.prototype.buildViewSpec = function(t) {
                    for (var e, n, r, i, o, s = this.optionsManager.overrides.views || {}, a = [], l = [], u = [], d = t; d;) e = p.viewHash[d], n = s[d], d = null, "function" == typeof e && (e = {
                        class: e
                    }), e && (a.unshift(e), l.unshift(e.defaults || {}), r = r || e.duration, d = d || e.type), n && (u.unshift(n), r = r || n.duration, d = d || n.type);
                    return (e = h.mergeProps(a)).type = t, !!e.class && ((r = r || this.optionsManager.dynamicOverrides.duration || this.optionsManager.overrides.duration) && (i = c.duration(r)).valueOf() && (o = h.computeDurationGreatestUnit(i, r), e.duration = i, e.durationUnit = o, 1 === i.as(o) && (e.singleUnit = o, u.unshift(s[o] || {}))), e.defaults = f.mergeOptions(l), e.overrides = f.mergeOptions(u), this.buildViewSpecOptions(e), this.buildViewSpecButtonText(e, t), e)
                }, t.prototype.buildViewSpecOptions = function(t) {
                    var e = this.optionsManager;
                    t.options = f.mergeOptions([f.globalDefaults, t.defaults, e.dirDefaults, e.localeDefaults, e.overrides, t.overrides, e.dynamicOverrides]), r.populateInstanceComputableOptions(t.options)
                    ...
                    n.buttonTextOverride = e(t.dynamicOverrides) || e(t.overrides) || n.overrides.buttonText, n.buttonTextDefault = e(t.localeDefaults) || e(t.dirDefaults) || n.defaults.buttonText || e(f.globalDefaults) || (n.duration ? this._calendar.humanizeDuration(n.duration) : null) || r
                }, t
            }();
        e.default = o
    }, function(t, e, n) {
        ...
        var i = n(3),
            ...
            h = function() {
                ...
                return t.prototype.requestEvents = function(t, e, n, r) {
                    ...
                    r.removeExact(this.otherSources, t), this.currentPeriod && this.currentPeriod.purgeSource(t)
            ...
            u = function() {
                ...
                return t.prototype.isWithinRange = function(t, e) {
                    ...
                    r && (t = i.removeMatching(r.eventInstances, function(t) {
                        return t.def === e
                    }), r.eventInstances.length || delete n[e.id], t && this.tryRelease())
        ...
        var o = n(3),
            ...
            s = function() {
                ...
                return t.prototype.start = function(t) {
                    this.isFollowing || (this.isFollowing = !0, this.y0 = r.getEvY(t), this.x0 = r.getEvX(t), this.topDelta = 0, this.leftDelta = 0, this.isHidden || this.updatePosition(), r.getEvIsTouch(t) ? this.listenTo(o(document), "touchmove", this.handleMove) : this.listenTo(o(document), "mousemove", this.handleMove))
                    ...
                    this.isFollowing && !this.isAnimating && (this.isFollowing = !1, this.stopListeningTo(o(document)), t && r && !this.isHidden ? (this.isAnimating = !0, this.el.animate({
                        top: this.top0,
                        left: this.left0
                    }, {
                        duration: r,
        ...
        var i = n(2),
            ...
            r = function(r) {
                ...
                return i.__extends(t, r), t.prototype.renderFgSegs = function(t) {
                    ...
                    if (h.unshift("fc-time-grid-event", "fc-v-event"), o.isMultiDayRange(a.unzonedRange)) {
                        if (t.isStart || t.isEnd) {
                            ...
                            n = this._getTimeText(g, v, l), r = this._getTimeText(g, v, l, "LT"), i = this._getTimeText(g, v, l, null, !1)
                        }
                    ...
                    if (this.sortEventSegs(t), function(t) {
                            ...
                            for (e = 0; e < t.length; e++)
                                for (n = t[e], r = 0; r < n.length; r++)
                                    for ((i = n[r]).forwardSegs = [], o = e + 1; o < t.length; o++) s(i, t[o], i.forwardSegs)
                        }(e = function(t) {
                            var e, n, r, i = [];
                            for (e = 0; e < t.length; e++) {
        ...
        function o(t) {
            ...
            if (void 0 === t.forwardPressure) {
                for (e = 0; e < r.length; e++) o(n = r[e]), i = Math.max(i, 1 + n.forwardPressure);
                t.forwardPressure = i
            }
        }
        ...
        var r = n(2),
            ...
            i = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderSegs = function(t, e) {
                    var n, r, i, o = [];
                    for (this.eventRenderer.renderFgSegsIntoContainers(t, this.component.helperContainerEls), n = 0; n < t.length; n++) r = t[n], e && e.col === r.col && (i = e.el, r.el.css({
                        left: i.css("left"),
                        right: i.css("right"),
        ...
        var i = n(2),
            ...
            r = function(r) {
                ...
                return i.__extends(t, r), t.prototype.renderBgRanges = function(t) {
                    ...
                    var n, r, i, o, s, a, l, u = this.dayGrid.colCnt,
                    ...
                    function v(t) {
                        for (; i < t;)(l = (g[n - 1] || [])[i]) ? l.attr("rowspan", parseInt(l.attr("rowspan") || 1, 10) + 1) : (l = y("<td/>"), o.append(l)), f[n][i] = l, g[n][i] = l, i++
                    }
                    for (n = 0; n < c; n++) {
                        if (r = d[n], i = 0, o = y("<tr/>"), h.push([]), f.push([]), g.push([]), r)
                            for (s = 0; s < r.length; s++) {
                                for (v((a = r[s]).leftCol), l = y('<td class="fc-event-container"/>').append(a.el), a.leftCol !== a.rightCol ? l.attr("colspan", a.rightCol - a.leftCol + 1) : g[n][i] = l; i <= a.rightCol;) f[n][i] = l, h[n][i] = a, i++;
                                o.append(l)
                            }
                    ...
                    for (this.sortEventSegs(t), e = 0; e < t.length; e++) {
                        for (n = t[e], r = 0; r < i.length && o(n, i[r]); r++);
                        (i[n.level = r] || (i[r] = [])).push(n)
                    }
                    for (r = 0; r < i.length; r++) i[r].sort(s);
                    return i
                    ...
                    var n, r, i = this.view,
                        ...
                        a = i.isEventDefDraggable(o),
                        l = !e && s && t.isStart && i.isEventDefResizableFromStart(o),
                        u = !e && s && t.isEnd && i.isEventDefResizableFromEnd(o),
                        d = this.getSegClasses(t, a, l || u),
                        c = h.cssToStr(this.getSkinCss(o)),
                        p = "";
                    return d.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (p = '<span class="fc-time">' + h.htmlEscape(n) + "</span>"), r = '<span class="fc-title">' + (h.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a class="' + d.join(" ") + '"' + (o.url ? ' href="' + h.htmlEscape(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + p : p + " " + r) + "</div>" + (l ? '<div class="fc-resizer fc-start-resizer" />' : "") + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                }, t
            }(n(42).default);
        ...
        var r = n(2),
            ...
            i = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderSegs = function(t, s) {
                    var a, l = [];
                    return a = this.eventRenderer.renderSegRows(t), this.component.rowEls.each(function(t, e) {
                        ...
                        s && s.row === t ? r = s.el.position().top : ((n = i.find(".fc-content-skeleton tbody")).length || (n = i.find(".fc-content-skeleton table")), r = n.position().top), o.css("top", r).find("table").append(a[t].tbodyEl), i.append(o), l.push(o[0])
                    }), u(l)
                }, e
            }(n(58).default);
        e.default = i
        ...
        var r = n(2),
            ...
            i = function(e) {
                ...
                return r.__extends(t, e), t.prototype.attachSegEls = function(t, e) {
                    var n, r, i, o = [];
                    ...
                    var n, r, i, o = this.component.colCnt,
                        s = e.leftCol,
                        a = e.rightCol + 1;
                    return n = "businessHours" === t ? "bgevent" : t.toLowerCase(), i = (r = l('<div class="fc-' + n + '-skeleton"><table><tr/></table></div>')).find("tr"), 0 < s && i.append('<td colspan="' + s + '"/>'), i.append(e.el.attr("colspan", a - s)), a < o && i.append('<td colspan="' + (o - a) + '"/>'), this.component.bookendCells(i), r
                }, t
            }(n(57).default);
        e.default = i
    }, function(t, e, n) {
        ...
        var r = n(2),
            ...
            o = function(a) {
                ...
                return r.__extends(t, a), t.prototype.buildRenderRange = function(t, e, n) {
                    var r, i = a.prototype.buildRenderRange.call(this, t, e, n),
                        o = this.msToUtcMoment(i.startMs, n),
                        s = this.msToUtcMoment(i.endMs, n);
                    return this.opt("fixedWeekCount") && (r = Math.ceil(s.diff(o, "weeks", !0)), s.add(6 - r, "weeks")), new l.default(o, s)
                }, t
            }(i.default);
        e.default = o
    }, function(t, e, n) {
            ...
            i = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    var e, n = this.view,
                        ...
                        d = this.getBgColor(s);
                    return e = a.isAllDay ? n.getAllDayHtml() : n.isMultiDayRange(a.unzonedRange) ? t.isStart || t.isEnd ? c.htmlEscape(this._getTimeText(r.msToMoment(t.startMs), r.msToMoment(t.endMs), a.isAllDay)) : n.getAllDayHtml() : c.htmlEscape(this.getTimeText(o)), l && u.push("fc-has-url"), '<tr class="' + u.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + i.getClass("widgetContent") + '">' + (e || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + i.getClass("widgetContent") + '"><span class="fc-event-dot"' + (d ? ' style="background-color:' + d + '"' : "") + '></span></td><td class="fc-list-item-title ' + i.getClass("widgetContent") + '"><a' + (l ? ' href="' + c.htmlEscape(l) + '"' : "") + ">" + c.htmlEscape(s.title || "") + "</a></td></tr>"
        ...
        var i = n(2),
            ...
            r = function(r) {
                ...
                return i.__extends(t, r), t.prototype.handleClick = function(t, e) {
                    var n;
                    r.prototype.handleClick.call(this, t, e), o(e.target).closest("a[href]").length || (n = t.footprint.eventDef.url) && !e.isDefaultPrevented() && (window.location.href = n)
                }, t
            }(n(59).default);
        e.default = r
    }, function(t, e, n) {
                    ...
                    i = function(t) {
                        ...
                        return r.__extends(e, t), e.parse = function(t, e) {
                            ...
                            var a = this,
                                ...
                                i = this.ajaxSettings || {},
                                u = i.success;
                            return l ? (this.calendar.pushLoading(), c.Promise.construct(function(o, s) {
                                d.ajax(d.extend({}, c.JsonFeedEventSource.AJAX_DEFAULTS, i, {
                                    url: r,
                                    data: l,
                                    success: function(t, e, n) {
                                        var r, i;
                                        a.calendar.popLoading(), t.error ? (a.reportError("Google Calendar API: " + t.error.message, t.error.errors), s()) : t.items && (r = a.gcalItemsToRawEventDefs(t.items, l.timeZone), i = c.applyAll(u, a, [t, e, n]), d.isArray(i) && (r = i), o(a.parseEventDefs(r)))
                                    },
                                    error: function(t, e, n) {
                                        a.reportError("Google Calendar network failure: " + e, [t, n]), a.calendar.popLoading(), s()
                                    }
                                }))
                            })) : c.Promise.reject()
                            ...
                            return n && e && (r = "ctz=" + e, n = n.replace(/(\?.*?)?(#|$)/, function(t, e, n) {
                                return (e ? e + "&" : "?") + r + n
                            })), {
                                id: t.id,
                                title: t.summary,
                            ...
                            return i ? (t.hasZone() || (t = t.clone().utc().add(-1, "day")), e.hasZone() || (e = e.clone().utc().add(1, "day")), r = d.extend(this.ajaxSettings.data || {}, {
                                key: i,
                                timeMin: t.format(),
                                timeMax: e.format(),
                                singleEvents: !0,
                            ...
                            this.googleCalendarError && this.googleCalendarError.apply(n, i), r && r.apply(n, i), c.warn.apply(null, [t].concat(e || []))
                            ...
                            this.ajaxSettings || (this.ajaxSettings = {}), d.extend(this.ajaxSettings, t)
...
FullCalendar.datepickerLocale('da', 'da', fullCalendarData);

FullCalendar.locale("da", calendarLocale);