...
class OffersController extends \Phalcon\Mvc\Controller
{
	public function indexAction()
	{
		...
		else if(!$mail=Offers::findById($hash))
		{
		...
		{
			if(MailboxLogs::count([["offer_id" => (string)$mail->_id, "type" => "error", "created_at" => ['$gt' => $this->mymongo->getDate(time()-3600)]]]) > 6)
			{
